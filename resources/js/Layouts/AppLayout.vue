            ...
            <nav class="bg-white border-b border-gray-100">
                ...
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <!-- Navigation Links -->
                            <div
                                v-if="$page.props.user.role.includes('client')"
                            ...
                            >
                                ...
                                <NavLink
                                    ...
                                    :active="route().current('cats.index')"
                                >
                                    Cat
                                </NavLink>
                                <NavLink
                                    :href="route('adopts.index')"
                                    :active="route().current('adopts.index')"
                                >
                                    Adopt
                                </NavLink>
                                <NavLink
                ...
                >
                    <div class="pt-2 pb-3 space-y-1">
                        ...
                        <ResponsiveNavLink
                            :href="route('adopts.store')"
                            :active="route().current('adopts.store')"
                        >
                            Adopt
                        </ResponsiveNavLink>
                        <ResponsiveNavLink
