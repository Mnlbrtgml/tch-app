            ...
            <nav class="bg-white border-b border-gray-100">
                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                ...
                                <NavLink :href="route('cats.index')" :active="route().current('cats.index')">
                                    Cat
                                </NavLink>
                                <NavLink :href="route('adopts.index')" :active="route().current('adopts.index')">
                                    Adopt
                                </NavLink>
                ...
                <div :class="{'block': showingNavigationDropdown, 'hidden': ! showingNavigationDropdown}" class="sm:hidden">
                    <div class="pt-2 pb-3 space-y-1">
                        ...
                        <ResponsiveNavLink :href="route('cats.index')" :active="route().current('cats.index')">
                            Cat
                        </ResponsiveNavLink>
                        <ResponsiveNavLink :href="route('adopts.store')" :active="route().current('adopts.store')">
                            Adopt
                        </ResponsiveNavLink>
